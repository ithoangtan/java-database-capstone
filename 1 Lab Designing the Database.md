...
Consider defining the structure of other tables in the same format as the example above.
...
### If you're using GitHub in the browser

1. Open your `java-database-capstone` repository.
2. In the base directory, click **Add file -> Create new file**.
3. Name the file `schema-design.md`.
4. Paste your content and scroll down.
...
6. Select **Commit directly to the main branch** and click **Commit new file**.

Your file will now be saved and versioned in your repo.

### If you are not using the browser

1. Save your `schema-design.md` file.
...
```bash
git push https://<your_username>:<your_token>@github.com/<your_username>/java-database-capstone.git
```

## Conclusion

Well done! You've made key design decisions about how your smart clinic will store and structure data. More importantly, you've practiced thinking like a backend architect.

In the next labs, you will use your design as the blueprint for coding actual Java models using JPA and MongoDB.

Your design today will shape the rest of your project, so take pride in getting the foundation right!
